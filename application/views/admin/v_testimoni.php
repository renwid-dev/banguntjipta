            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Text Slider</label>
                                        <div class="col-sm-7">
                                            <textarea type="text" name="isi" class="form-control" id="inputUserName" placeholder="tuliskan testimoni" required></textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="nama" value="<?php echo $nama;?>" class="form-control" id="inputUserName" placeholder="Nama" required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">isi testimoni</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="isi" value="<?php echo $isi;?>" class="form-control" id="inputUserName" placeholder="Edit text" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                     <input value="<?php echo $photo;?>" name="testimoni_photo">
                            <p>Apakah Anda yakin mau menghapus testimoni ini <b><?php echo $nama;?></b> ?</p>
