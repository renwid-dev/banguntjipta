                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="title" class="form-control" id="inputUserName" placeholder="Title" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <textarea type="text" name="text" class="form-control" id="inputUserName" placeholder="tuliskan text" required></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Link Slider</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="link" class="form-control" id="inputUserName" placeholder="Link slider ex: https://temanrendy.tech" required>
                                        </div>
                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Judul Slider</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="title" value="<?php echo $title;?>" class="form-control" id="inputUserName" placeholder="Judul" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Text Slider</label>
                                        <div class="col-sm-7">
                                            <textarea type="text" name="text" value="<?php echo $text;?>" class="form-control" id="inputUserName" placeholder="Edit text" required></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tulis link</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="link" value="<?php echo $link;?>" class="form-control" id="inputUserName" placeholder="Edit link" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                     <input type="hidden" value="<?php echo $photo;?>" name="slider_photo">
                            <p>Apakah Anda yakin mau menghapus slider ini <b><?php echo $title;?></b> ?</p>
